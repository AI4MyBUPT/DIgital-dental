...
from aagt.engine.base_trainer import BaseTrainer
from aagt.utils.torch import to_cuda
from aagt.utils.summary_board import SummaryBoard
from aagt.utils.timer import Timer
from aagt.utils.common import get_log_string
from aagt.utils.data import precompute_neibors
...
class EpochBasedTrainer(BaseTrainer):
    ...
    def inference_epoch(self):
        ...
        if self.use_ema and self.ema_model is not None:
            self.logger.info("Switching to EMA model for validation...")
